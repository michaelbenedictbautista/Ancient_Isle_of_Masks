...
void Creep::update1()
{
	try {
		...
		// Motion of a creep
		//m_destinationRectangle.y += enemyStep; // move vertically only
		...
		if (m_destinationRectangle.y > (880 - m_destinationRectangle.h) &&
		...
		if (m_destinationRectangle.y > 900 - m_destinationRectangle.h) {
			m_destinationRectangle.y = 890;
		}

		//cout << move_bouncing->getY() << "\n";
...
void Creep::update2()
{
	try {
		...
		// Motion of a creep
		//m_destinationRectangle.x += enemyStep; // move Horizontally only
...
//	if (m_angle != 0) {
//
//		m_creep.x += (m_creep.w - m_creep.h) / 2;
//		m_creep.y -= (m_creep.w - m_creep.h) / 2;
//
//		int temp = m_creep.w;
//		m_creep.w = m_creep.h;
//		m_creep.h = temp;
